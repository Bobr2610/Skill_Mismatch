...
\usepackage{fancyhdr}\pagestyle{fancy}\fancyhead[L]{Skill Mismatch}\fancyhead[R]{\thepage}\fancyfoot[C]{MAI --- 2025}\renewcommand{\headrulewidth}{0.4pt}\renewcommand{\contentsname}{Оглавление}
\usepackage{bookmark}
