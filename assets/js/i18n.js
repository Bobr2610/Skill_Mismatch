...
const I18N_DICT = {
  en: {
    ...
    'profile.activity_desc': '6 parameters from MathModel: W, ΔMI, CI, RF, SV, CA — AI evaluates from activity data',
    'profile.recent_activity': 'Recent Activity',
    'profile.ai_title': 'AI Career Recommendation',
    'profile.ai_desc': 'Based on 6 MathModel stats and position: promote, demote, or keep',
    ...
    'profile.commit_title': 'Commit Contribution',
    'profile.commit_desc': 'AI analyzes a commit and adds points to relevant stats',
    'profile.commit_placeholder': 'Enter commit message...',
    'profile.commit_analyze': 'Analyze Commit',
    'profile.commit_analyzing': 'Analyzing...',
    'profile.commit_done': 'Commit analyzed — stats updated',
    'profile.commit_pending': 'PENDING',
    'profile.commit_auto': 'Auto-analyzing commits',
    'profile.commit_auto_done': 'Auto-analysis complete',
    'profile.decay_title': 'Monthly Decay',
    'profile.decay_desc': 'Applies stat × K(role) — stats decrease without new activity',
    'profile.decay_apply': 'Apply Monthly Decay',
    'profile.decay_applying': 'Applying...',
    'profile.decay_done': 'Monthly decay applied',
  ...
  ru: {
    ...
    'profile.activity_desc': '6 параметров MathModel: W, ΔMI, CI, RF, SV, CA — ИИ оценивает по данным активности',
    'profile.recent_activity': 'Последняя активность',
    'profile.ai_title': 'ИИ-рекомендация по карьере',
    'profile.ai_desc': 'На основе 6 параметров MathModel и позиции: повысить, понизить или оставить',
    ...
    'profile.commit_title': 'Вклад коммита',
    'profile.commit_desc': 'ИИ анализирует коммит и начисляет баллы в соответствующие параметры',
    'profile.commit_placeholder': 'Введите сообщение коммита...',
    'profile.commit_analyze': 'Анализировать коммит',
    'profile.commit_analyzing': 'Анализ...',
    'profile.commit_done': 'Коммит проанализирован — статы обновлены',
    'profile.commit_pending': 'ОЖИДАНИЕ',
    'profile.commit_auto': 'Авто-анализ коммитов',
    'profile.commit_auto_done': 'Авто-анализ завершён',
    'profile.decay_title': 'Ежемесячное затухание',
    'profile.decay_desc': 'Применяет стат × K(роль) — статы снижаются без активности',
    'profile.decay_apply': 'Применить затухание',
    'profile.decay_applying': 'Применение...',
    'profile.decay_done': 'Затухание применено',
